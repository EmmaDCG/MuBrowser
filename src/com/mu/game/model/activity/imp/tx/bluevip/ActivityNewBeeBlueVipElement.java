...
public class ActivityNewBeeBlueVipElement extends ActivityBlueVipElement {
   public ActivityNewBeeBlueVipElement(int id, ActivityBlueVip father) {
      super(id, father);
   }
   ...
   public boolean canReceive(Player player, boolean notice) {
      ...
      return !bv.isVip() ? false : super.canReceive(player, notice);
   }
