...
public class ActivitySuperBlueElement extends ActivityBlueVipElement {
   public ActivitySuperBlueElement(int id, ActivityBlueVip father) {
      super(id, father);
   }
   ...
   public boolean canReceive(Player player, boolean notice) {
      ...
      return !bv.is_super_blue_vip() ? false : super.canReceive(player, notice);
   }
