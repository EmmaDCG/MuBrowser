...
public class ZhuoYueActivity extends Activity {
   public ZhuoYueActivity(int id) {
      super(id);
      this.digitalRelationId = 8;
   }
   ...
   public void init(Object obj) throws Exception {
      ...
      for(int i = 2; i <= rows; ++i) {
         ...
         ZhuoYueElement ae = new ZhuoYueElement(eid, this);
   ...
   public void writeDetail(Player player) {
      ...
      try {
         ...
         ai.writeByte(player.getEquipment().getTotalExcellentCount());
         ...
         while(var5.hasNext()) {
            ...
            ZhuoYueElement ae = (ZhuoYueElement)element;
