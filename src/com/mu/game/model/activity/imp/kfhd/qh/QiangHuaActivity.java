...
public class QiangHuaActivity extends Activity {
   public QiangHuaActivity(int id) {
      super(id);
      this.digitalRelationId = 9;
   }
   ...
   public void init(Object obj) throws Exception {
      ...
      for(int i = 2; i <= rows; ++i) {
         ...
         QiangHuaElement ae = new QiangHuaElement(eid, this);
   ...
   public void writeDetail(Player player) {
      ...
      try {
         ...
         ai.writeByte(player.getEquipment().getTotalStar());
         ...
         while(var5.hasNext()) {
            ...
            QiangHuaElement ae = (QiangHuaElement)element;
