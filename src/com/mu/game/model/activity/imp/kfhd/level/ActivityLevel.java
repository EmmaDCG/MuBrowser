...
public class ActivityLevel extends Activity {
   public ActivityLevel(int id) {
      super(id);
      this.digitalRelationId = 5;
   }
   ...
   public void init(Object obj) throws Exception {
      ...
      for(int i = 2; i <= rows; ++i) {
         ...
         ActivityLevelElement ae = new ActivityLevelElement(eid, this);
   ...
   public void writeDetail(Player player) {
      ...
      try {
         ...
         while(var5.hasNext()) {
            ...
            ActivityLevelElement ae = (ActivityLevelElement)element;
