...
public class ActivityEquip extends Activity {
   public ActivityEquip(int id) {
      super(id);
      this.digitalRelationId = 7;
   }
   ...
   public void init(Object obj) throws Exception {
      ...
      for(int i = 2; i <= rows; ++i) {
         ...
         ActivityEquipElement ae = new ActivityEquipElement(eid, this);
   ...
   public void writeDetail(Player player) {
      ...
      try {
         ...
         while(var5.hasNext()) {
            ...
            ActivityEquipElement ae = (ActivityEquipElement)element;
