...
public class ReduceIngotLogExecutor extends Executable {
   public ReduceIngotLogExecutor(int type) {
      super(type);
   }

   public void execute(Game2GatewayPacket packet) throws Exception {
      ReduceIngotLogTask.addChangeLog(packet);
   }
   ...
   public void toPacket(ExecutePacket packet, Object... obj) throws Exception {
      ...
      String reduceDetail = (String)obj[3];
